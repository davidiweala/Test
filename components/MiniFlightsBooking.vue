<template>
  <div class="flights-booking mobileFB">
     <div class="expanded" v-show="!miniFlights">
      
      <div class="cancel">
       <FontAwesomeIcon class="fa-xl" @click="toggleMiniFlights" icon="fa-solid fa-close" />
       </div>
   <div class="options">
      <div>
 ...
 <div class="flight-engine"  >
   ...
   + Add a trip
     ...
     Search
      ...
      <div v-show="miniFlights" class="compressed">
 ...
 <div class="flight-engine"  >
      <div class="f-input">
        <img src="~/assets/svg/location.svg" />
        <input disabled placeholder="From where ?" />
        </div>
    ...
    <input disabled placeholder="From where ?" 
      ...
      <div class="f-input f-others">
          <input disabled placeholder="1 Traveler" />
   
      </div>

      <div class="f-input f-others">
          <input disabled placeholder="Economy" />
      

      </div>

      <button @click="toggleMiniFlights" class="search">
    <img src="~/assets/svg/edit.svg"/>    Modify
      </button>
...
export default {
  ...
  computed: {
    ...
    miniFlights(){
        return this.$store.getters.miniFlights;
    },
 /*   yesterdayDate(){
        var date = new Date();
  ...
  methods: {
    ...
    toggleMiniFlights(){
        let flights = !this.miniFlights;
        console.log(flights)
        this.$store.commit('toggleMiniFlights', flights)
    },
    checkDate(index){
         var date = new Date();
